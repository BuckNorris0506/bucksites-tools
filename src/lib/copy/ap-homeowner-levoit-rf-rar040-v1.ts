export const AP_HOMEOWNER_LEVOIT_RF_RAR040_COPY = {
  eyebrow: "Levoit air purifier",
  h1: "Levoit Core 400 / Core 400S replacement filter",
  notSeller:
  ...
  modelCheckWrongModelBody:
    "Other Levoit Core families — Core 200, Core 300, and Core 600 — use different filters. If your unit is one of those, search that model instead.",
  differentModel: "I have a different model",
  compatTitle: "Works with these purifiers",
  compatBody: "These Levoit models use this replacement filter.",
  trustTitle: "Why you can trust this match",
  trustOfficialListingClause:
    "Buy links are checked against Levoit's official product listing. BuckParts re-checks listings periodically; a listing check is not a permanent guarantee.",
  trustOfficialListingLastCheckLabel: "Most recent listing check:",
} as const;
