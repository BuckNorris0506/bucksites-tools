...
test("refrigerator disposition meaning preserved for committed reference slugs", () => {
  ...
  const expected: Record<string, string> = {
    ...
    adq75795101: "NEEDS_COMPATIBILITY_OR_SUPERSESSION_LABEL",
    "da97-19467c": "AUDIT_WRONG_PART_RISK",
    "frig-242017801": "NEEDS_COMPATIBILITY_OR_SUPERSESSION_LABEL",
    gswf2: "NO_SAFE_LINK_FOUND_KEEP_SUPPRESSED",
    mswf: "NEEDS_COMPATIBILITY_OR_SUPERSESSION_LABEL",
    opfg3f: "NO_SAFE_LINK_FOUND_KEEP_SUPPRESSED",
    pfmwf: "NO_SAFE_LINK_FOUND_KEEP_SUPPRESSED",
