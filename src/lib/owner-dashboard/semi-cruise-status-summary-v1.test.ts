...
function baseV2() {
  return {
    ...
    large_batch_coverage_factory_summary_v1: {
      report_name: "buckparts_large_batch_coverage_factory_summary_v1" as const,
      contract: "large_batch_coverage_factory_summary_v1" as const,
      read_only: true as const,
      data_mutation: false as const,
      mutation_ready: false as const,
      generated_at: "2026-05-19T00:00:00.000Z",
      runtime_status: "OK" as const,
      source_command: "npm run buckparts:large-batch-coverage-factory" as const,
      factory_report_name: "buckparts_large_batch_coverage_factory_v1" as const,
      candidate_count: 57,
      state_counts: {
        existing_live_product: 57,
      ...
      blocked_counts: { total: 0, by_reason: {} },
      top_5_candidates: [],
      next_owner_action: "Review factory cohort in Command Center.",
      next_agent_action: "Run read-only factory report; do not mutate production.",
      ...
      goat_c1_dual_output_leverage_counter_v1: {
        contract: "goat_c1_dual_output_leverage_counter_v1",
        read_only: true,
        data_mutation: false,
        cohort_row_count: 0,
        measurable: false,
