...
import {
  FRIDGE_HOMEKEEP_BULK_FILTERS_BY_BRAND_V1,
  type FridgeHomekeepBulkFilterEntryV1,
...
type F = FridgeHomekeepBulkFilterEntryV1;

const FILTERS = FRIDGE_HOMEKEEP_BULK_FILTERS_BY_BRAND_V1;
