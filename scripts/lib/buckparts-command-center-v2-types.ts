...
import type { FridgeGuardedBatchLifecycleRulePromotionPlanLaneV1 } from "./fridge-guarded-batch-lifecycle-rule-promotion-plan-command-center-v1";
...
import type { RefrigeratorModelFirstQaApprovalPacketCommandCenterLaneV1 } from "./refrigerator-model-first-mapping-review-founder-approval-packet-v1";
...
export type LiveSiteMonitorContentContractStatusV1 =
  | "OK"
  | "ATTENTION"
  | "UNKNOWN"
  | "UNKNOWN_CONFIG";
...
export type CommandCenterV2Report = {
  ...
  /** Read-only fridge buyer-path apply-plan owner approval bridge — planning-only; not apply authority. */
  fridge_buyer_path_batch_apply_plan_approval_v1: FridgeBuyerPathBatchApplyPlanApprovalCommandCenterLaneV1;
  ...
  /** Read-only owner-approval-ready active-rule promotion plan — not an active registry or enforcement. */
  fridge_guarded_batch_lifecycle_rule_promotion_plan_v1: FridgeGuardedBatchLifecycleRulePromotionPlanLaneV1;
  ...
  /** Read-only refrigerator QA / wrong-purchase-prevention approval packet — visibility only; not CSV apply authority. */
  refrigerator_model_first_qa_approval_packet_v1: RefrigeratorModelFirstQaApprovalPacketCommandCenterLaneV1;
  ...
  /** Read-only manufacturer safe-link rescue runner — deterministic execution plans from director lane; not CSV apply authority. */
  ...
  /** Read-only manufacturer browser proof refresh orchestrator — schedules manufacturer refresh batches from factory output. */
  ...
  /** Read-only RPWFE official GE Supabase parity plan — compares repo CSV to expected DB row; no Supabase writes. */
  rpwfe_official_ge_supabase_parity_plan_v1: RpwfeOfficialGeSupabaseParityPlanLaneV1;
  ...
  /**
   * Phase 4 Decision-Capture — read-only sibling to coverage scoreboard.
...
export type { FridgeGuardedBatchLifecycleRulePromotionPlanLaneV1 } from "./fridge-guarded-batch-lifecycle-rule-promotion-plan-command-center-v1";
...
export type { UniversalBatchLifecycleTruthTableV1 } from "./universal-batch-lifecycle-truth-table-v1";
...
export type { RefrigeratorModelFirstQaApprovalPacketCommandCenterLaneV1 } from "./refrigerator-model-first-mapping-review-founder-approval-packet-v1";
