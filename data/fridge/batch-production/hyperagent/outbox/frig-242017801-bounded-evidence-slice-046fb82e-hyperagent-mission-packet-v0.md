# HyperAgent mission packet v0 — frig-242017801-bounded-evidence-slice-046fb82e
...
- dedup_key: `BOUNDED_EVIDENCE_SLICE:filter::frigidaire::frig-242017801`
- deliverable: `data/fridge/batch-production/drafts/frig-242017801-bounded-evidence-slice-046fb82e-hyperagent-ingest-packet-v1.json`
...
family_key: filter::frigidaire::frig-242017801
mission_type: BOUNDED_EVIDENCE_SLICE
scope_key: filter::frigidaire::frig-242017801
queue_item_id: ada897261219ce09
...
Slug batch (4):
- frigidaire-fghd2365tf
- frigidaire-frfs2613as
- frigidaire-grfs2633af
- frigidaire-grfs2833af
Requirements:
...
Repo context: Evidence leverage ranks filter::frigidaire::frig-242017801 highly, but pre-research risk screen blocks full-family scaling (15 sibling conflicts, 0 learned-failure blocks).
Queue title: Block full-family HyperAgent dispatch for `filter::frigidaire::frig-242017801` — pre-research risk screen HIGH/NEEDS_REPO_RECONCILIATION_FIRST. Optional 4-slug conflict-free research slice (frigidaire-fghd2365tf, frigidaire-frfs2613as, frigidaire-grfs2633af, frigidaire-grfs2833af) — not full-family scaling.
```
