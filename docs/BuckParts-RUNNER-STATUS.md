...
| 2026-05-15 | **Founder Decision Registry v1:** `docs/BuckParts-FOUNDER-DECISION-REGISTRY.md` + `src/lib/owner-dashboard/founder-decision-registry-v1.ts` + optional `data/owner-decisions/` — contract for recording owner decisions; **PROVEN:** no Runner/digest automation reads or writes registry files yet. |
