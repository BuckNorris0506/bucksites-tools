...
| Part trust scoring/panel | `src/lib/trust/part-trust.ts`, `src/components/trust/PartTruthPanel.tsx` | Computes and displays trust states for part pages. | yes/no/yes/no/no | Permanent | KEEP | User-facing trust system. |
