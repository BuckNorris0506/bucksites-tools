-- Amazon LT1000P retailer_links insert plan (read-only doc; dry-run transaction).
-- Prepared 2026-05-01.
...
-- =============================================================================
-- Token: LT1000P
-- filter_id: 351b197d-ecac-428e-aa99-39cfad397692
-- filter_slug: lt1000p
...
-- - Source inspected listing (SEO /dp path): https://www.amazon.com/Waterdrop-Refrigerator-Replacement-ADQ74793501-ADQ74793502/dp/B07H9LHMR2
-- - PDP copy references LT1000P and ADQ747935 cross-references; listing is third-party compatible, not LG OEM.
--
...
--   -- 3d8224c2-4a60-4042-9642-f02a8ce63543
--
...
SELECT
  ...
  oem_part_number
FROM public.filters
WHERE id = '351b197d-ecac-428e-aa99-39cfad397692'::uuid
   OR lower(slug) = 'lt1000p'
   OR upper(oem_part_number) = 'LT1000P'
ORDER BY id;
...
WHERE filter_id = '351b197d-ecac-428e-aa99-39cfad397692'::uuid
...
--    browser_truth_notes: aftermarket Waterdrop compatible replacement, NOT LG OEM.
-- ---------------------------------------------------------------------------
...
SELECT
  '351b197d-ecac-428e-aa99-39cfad397692'::uuid,
  'Amazon',
  'amazon',
  ...
  'direct_buyable',
  NULL,
  'Aftermarket Waterdrop compatible replacement for LT1000P (ASIN B07H9LHMR2); PDP cross-refs LT1000P/ADQ747935 family. Not LG OEM.',
  now()
WHERE NOT EXISTS (
  SELECT 1
  FROM public.retailer_links l
  WHERE l.filter_id = '351b197d-ecac-428e-aa99-39cfad397692'::uuid
